...
server.listen(process.env.port || 3978, function () {
    console.log("".concat(server.name, " listening on ").concat(server.url));
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, context.sendActivity("you said ".concat(context.activity.text))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, context.sendActivity("".concat(context.activity.type, " event detected"))];
                case 3:
                    _a.sent();
                    _a.label = 4;
